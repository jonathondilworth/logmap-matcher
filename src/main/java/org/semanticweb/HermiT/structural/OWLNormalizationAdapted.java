 ...
 */
public class OWLNormalizationAdapted {
    protected final OWLDataFactory m_factory;
    protected final OWLAxiomsAdapted m_axioms;
    ...
    public OWLNormalizationAdapted(OWLDataFactory factory,OWLAxiomsAdapted axioms,int firstReplacementIndex) {
        m_factory=factory;
        m_axioms=axioms;
